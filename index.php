...
{
	if ($action == "/") {
        echo "<h2>Queries Examples<h2>";
        echo "<h4>1. To Get Data About Specific Country use Query: /data/{Country Name}</h4>";
        echo "<h4>2. To Get All Data Uue Query: /data or /data/</h4>";
        echo "<h4>3. To Get Sorted Data: /data/sor={Field Name}</h4>";
        ...
        echo "<h4>4. To Get Data according to set of attributes use Query: /data?{Attribute Name}[lte OR gte: this is optional]";
        echo "<h5 style='color: red'>OR</h5>";
        echo "<h4>5. /data?{Attribute Name}[lte OR gte: this is optional]&{Attribute Name}[lte OR gte: this is optional]....</h4>";
